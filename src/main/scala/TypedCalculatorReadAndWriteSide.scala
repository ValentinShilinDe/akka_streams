...
object TypedCalculatorReadAndWriteSide {
  ...
  def main(args: Array[String]): Unit = {
    implicit val system: ActorSystem[NotUsed] = ActorSystem(TypedCalculatorReadAndWriteSide(), "TypedCalculatorReadAndWriteSide")
