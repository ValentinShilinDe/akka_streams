...
import akka_typed.CalculatorRepository.{Result, getLatestsOffsetAndResultSlick, updatedResultAndOffset}
...
object akka_typed {
  ...
  case class TypedCalculatorReadSide(system: ActorSystem[NotUsed])(implicit
